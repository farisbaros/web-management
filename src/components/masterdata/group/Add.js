...
import { addGroup, getClient , getOperator, getPortGsm, getPrivileges} from './Action';
...
class Add extends Component {
    ...
    getPrivilegesMap() {
        ...
        this.props.privileges.map((item, index) => {
            privilegesMap.set(item.previlegeTemplateId, item);
        });
    ...
    // getPrivilegesObject(operatorId) {
    //     privilegesObject = new Object();
    //     privilegesMap = this.getPrivilegesMap();
    //     privilegesObject = privilegesMap.get(parseInt(operatorId[idx])));
    //         idx++;
    //     });
    //     return operatorObjList;
    // }
    ...
    render() {
        const { data, loading, client, operator, portGsm, privileges } = this.props;
                        ...
                        <Card>
                            ...
                            <CardBody>
                                ...
                                <FormGroup row>
                                    ...
                                    <Col xs="12" md="9">
                                        <CheckBoxComponent checked={this.state.blackListStatus} ref={(scope) => { this.checkboxObj = scope; }} change={this.onChangeBlackListStatus}></CheckBoxComponent>
                                    </Col>
                                    </FormGroup>
                                <div style={{ display: this.state.hostToHost == true ? 'block' : "none" }}>
                                    ...
                                    <Col xs="12" md="9">
                                        <CheckBoxComponent checked={this.state.callableApiFlag} ref={(scope) => { this.checkboxObj = scope; }} change={this.onChangecallableApiFlag}></CheckBoxComponent>
                                    </Col>
                                        </FormGroup>
                                </div>
                                <div style={{display:this.state.callableApiFlag == true ? 'block' : "none"}}>
                                    <FormGroup row>
                                        ...
                                        <Col xs="12" md="9">
                                            <Input type="text" id="callableApiUrl" name="callableApiUrl" onChange={this.handleInputChange} placeholder="Enter URL..." autoComplete="off" ref="callableApiUrlInput" />
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row>
                                        <Col md="3">
                                        ...
                                        <Col xs="12" md="9">
                                            <Input type="text" id="callableApiUsername" name="callableApiUsername"  onChange={this.handleInputChange} placeholder="Enter User Name..." autoComplete="off" />
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row>
                                        <Col md="3">
                                        ...
                                        <Col xs="12" md="9">
                                            <Input type="password" id="callableApiPassword" name="callableApiPassword" onChange={this.handleInputChange} placeholder="Enter Password..." autoComplete="off" />
                                        </Col>
                                    </FormGroup>
                                </div>
